...
--
-- Host: localhost:80
-- Generation Time: Sep 27, 2016 at 11:16 PM
...
INSERT INTO `membercredentials` (`id`, `name`, `password`) VALUES
(7, 'amir', 'khan'),
(10, 'karina', 'kapoor'),
(12, 'yooooo', 'kapoor'),
(13, 'sahil', 'ratnarani');
...
INSERT INTO `taskalloted` (`id`, `username`, `work`) VALUES
(1, 'sahil', 'ufbsduyvbyudv'),
